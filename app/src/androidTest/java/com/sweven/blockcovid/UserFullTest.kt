    ...
    fun userFullTest() {
        ...
        val switchMaterial = onView(
            allOf(
                ...
                childAtPosition(
                    allOf(
                        withId(R.id.frame_layout_theme),
                        childAtPosition(
        ...
        val bottomNavigationItemView2 = onView(
            allOf(
                withId(R.id.navigation_user_rooms),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.nav_view),
                        0
        ...
        val materialButton7 = onView(
            allOf(
                withId(R.id.my_reservations_button),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.nav_host_fragment_user),
                        0
        ...
        val materialButton10 = onView(
            allOf(
                withId(R.id.edit_reservation_button),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.nav_host_fragment_user),
                        0
        ...
        val materialButton12 = onView(
            allOf(
                withId(R.id.remove_reservation_button),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.nav_host_fragment_user),
                        0
