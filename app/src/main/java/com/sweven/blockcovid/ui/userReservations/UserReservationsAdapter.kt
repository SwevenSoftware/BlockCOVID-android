...
class UserReservationsAdapter(ct: Context?, nc: NavController, ri: Array<String>, di: Array<String>, sa: Array<String>, ea: Array<String>, da: Array<String>, ra: Array<String>): RecyclerView.Adapter<UserReservationsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.reservationRoom.text = roomArray[position]
